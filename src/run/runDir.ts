 ...
 *   throws if it is absolute, or if it resolves to the run directory itself
 *   or anywhere outside it (e.g. "../escape" or "a/../../b") — plain nested
 *   paths like "sub/file.csv" are allowed
 * @returns the absolute path of relPath inside runDir; the returned path is
 *   guaranteed to lie strictly within the run directory
 */
