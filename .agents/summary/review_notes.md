...
1. **Production has one path.** `src/agent/runTask.ts` composes the initializer, sequential worker, deterministic finish checks, fresh verifier, static eight-tool registry, and durable lifecycle.
