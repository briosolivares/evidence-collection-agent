...
Contributor guide and binding rules for this repository. Start with
[the implementation plan](docs/browser-agent-v3/implementation-plan.md) for
progress and [the design doc](docs/browser-agent-v3/sherlock-v3-design-doc.md)
for rationale. Dated eval reports live in `docs/reports/`; the browser-layer
research that informed the design lives in `docs/research/`.
