...
/**
 * Load one eval task from its directory under evals/: task.json for the
 * task text and start URL, oracle/oracle.ts for `fetchOracle`, and
 * grader/grader.ts for `grade`.
 *
