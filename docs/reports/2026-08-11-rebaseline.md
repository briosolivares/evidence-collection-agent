...
- **F3 — 24-turn default.** EDGAR trials finished in 10–11 turns *including* read-back verification and exhibit downloads, where baseline trials died at the 12-turn wall mid-recovery. No trial came near the 24-turn ceiling. The 250k token guard did fire once: EDGAR trial 3's recovery loop ended `budget_exceeded` at 250,835 cumulative input tokens on turn 11 — *after* every artifact had landed, so it still passed 3/3. Trials 1–2 finished at 234–235k: EDGAR's token headroom is thin, the knob to watch if deeper recovery loops appear.
