...
for company in data['companies']:
    ...
    for founder in company['founders']:
        ...
        email = (
            f"Subject: 15 minutes to learn about {cname}?\n\n"
            f"Hi {first_name},\n\n"
            ...
            f"I'm reaching out because I'd love to learn more about your approach as {founder['role']} at {cname} and share a few thoughts on where I think there could be mutual value. "
            f"Would you be open to a quick 15-minute call sometime in the next week or two? I'll happily work around your schedule.\n\n"
